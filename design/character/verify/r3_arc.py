...
★ R2 §5·§7 이 인용한 출하 대역 73~134°는 **모자+안경 36조합** 값이었다(아래 (c)가 그것을 재현한다).
   즉 R2 의 비교는 같은 축끼리였다. 다만 r2_final.py 57행이 인쇄하는 것은 **모자 단독**(124~162°)이라
   문서만 보면 어느 쪽인지 알 수 없었다 — 여기서 (a)(b)(c)를 갈라 못박는다.
