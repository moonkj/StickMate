...
def straight():
    ...
    return [Shape("HairMass", pts, filled=True),
            # ★ 2026-09-05 — 가르마 폭축만 x1.40(R13 P3이 프로덕션에 착지). 폭 0.40 -> 0.56 R.
            #   rho 0.1938R(0.89획) -> 0.2631R(1.21획), 배율 0.60 몽당변(0.93획)도 사라진다.
            Shape("HairPart", [(-0.27,1.57), (0.29,1.54), (0.57,0.59), (0.01,0.64)],
                  filled=True, tone=1)]
