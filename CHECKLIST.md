...
- [ ] **DLC 12종 착용 모습을 카드 비트맵에 더 가깝게 재설계** (2026-09-08) — 맥 실행 확인 중
  ...
  - [ ] design-equipment 배정 — 12종 최종 비트맵(Icons/*.png)에서 색상·실루엣을 직접 샘플링해
        착용 시 벡터가 카드와 최대한 가깝게 보이도록 R3 사양 작성.
  - [ ] coder-systems 착지 + EditMode 검증 + macOS 실기 재캡처(카드-착용 나란히 비교)로 확정.
