...
namespace StickMate.Core
{
    ...
    ///
    /// 이 클래스는 <b>언제 XP가 들어오는지 전혀 모른다</b>. 패시브 적립과 보너스 훅(격파 승리 /
    /// 활쏘기 명중)은 전부 Interaction/CharacterProgressionDirector.cs의 책임이고, 저장/로드는
    ...
    /// 배낭(Lv22)도 378시간(47일)이었다 — 보너스 XP(격파/대결/명중 25~40XP)로는 하루 500회 이상 승리해야
