...
namespace StickMate.Interaction
{
    ...
    public sealed partial class CharacterInfoWindow
    {
        ...
        // ==================== 진단/테스트 전용 — 초상화 촬영장 / 보관함 레일 (2026-09-02) ====================
        // ★ 2026-09-07 — 여기 있던 PresenceTextForTests를 지웠다. 프레즌스 줄(프리뷰 무대 하단의
        //   상태 텍스트) 자체가 프로덕션에서 통째로 제거됐다(CharacterInfoWindow.cs 참고,
        //   사용자 신고: "현재 상태 추적하지말고 다빼줘").
