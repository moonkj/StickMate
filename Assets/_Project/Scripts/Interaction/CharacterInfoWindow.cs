...
namespace StickMate.Interaction
{
    ...
    public sealed partial class CharacterInfoWindow : MonoBehaviour, IExclusiveSurface
    {
        ...
        /// 부딪히지 않는다 — <b>팩 12장은 알파 채널이 없어</b>(PNG 컬러타입 2 = RGB) 바깥 배경이
        /// <b>칠해져</b> 들어오기 때문이다. 2026-09-08 실측이고, 그날 오전 판(4장이 RGBA였다)과
        /// <b>다르다</b>: 이 그림들은 라운드 도중에 한 번 교체됐다. 다시 잴 때는 파일 mtime부터 봐라.
        /// <br/>★ <b>2026-09-09 정정 — 「전부」가 아니게 됐다.</b> 왕관 카드 파생본
        /// (<c>equip_head_crown.png</c>, 우리가 굽는 그림)은 <b>알파를 보존</b>한다. 그래서 그 한 장은
        /// 판 색을 그대로 비추고, 이 6pt 틈은 그 장에게는 «안 부딪히게 하는 장치»가 아니라
        /// 단순한 여백이다. 값은 그대로 두는 편이 맞다 — 팩 12장에는 여전히 필요하고,
        /// 두 계통이 서로 다른 상자를 쓰면 카드 줄에서 크기가 갈린다.</para>
        /// </summary>
