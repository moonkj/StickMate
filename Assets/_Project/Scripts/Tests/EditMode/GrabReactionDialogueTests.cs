...
namespace StickMate.Tests.EditMode
{
    ...
    /// ============================================================================
    /// 9줄 중 <b>5줄이 가독예산 클램프 바닥</b>(<c>DialogueBudget.MinSeconds</c>)에 붙어 있다
    /// (2026-09-03 재측정 — 리더 판정으로 공통 줄 하나가 4자 → 5자가 되며 6줄에서 5줄로 줄었다).
    /// <c>PerGlyphSeconds</c>를 아무 값으로 흔들어도 그 5줄의 예산은 <b>한 톨도 안 변한다</b> —
